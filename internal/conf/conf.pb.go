...
type Jwt struct {
	...
	MaxRefresh string `protobuf:"bytes,3,opt,name=max_refresh,json=maxRefresh,proto3" json:"max_refresh,omitempty"`
}
...
func (x *Jwt) GetMaxRefresh() string {
	if x != nil {
		return x.MaxRefresh
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x52, 0x0a, 0x03, 0x4a,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x1f,
	0x0a, 0x0b, 0x6d, 0x61, 0x78, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x22,
	...
	0x1b, 0x5a, 0x19, 0x67, 0x6f, 0x2d, 0x73, 0x69, 0x6d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
